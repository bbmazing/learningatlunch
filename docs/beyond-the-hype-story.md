...
browser mock of Chat OCBC: padlock URL bar with
chat-ocbc.wssdx.apps.cml.ocbcnisp.com, a Bahasa greeting bubble, and a
typed starter prompt ready to send.
...
## Slide 17 · Bridge: three walls still stand — 1 min
